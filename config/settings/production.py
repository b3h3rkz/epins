...
SECRET_KEY = env('DJANGO_SECRET_KEY', default='NTSVkBAvI$Surzk&*4kjU*yd2)*]<!oarr=fat[ppkL%a[uU#[')
...
# MAIL_BACKEND = "sgbackend.SendGridBackend"
...
# DATABASES['default'] = env.db('DATABASE_URL', default="postgres:///barbary")
